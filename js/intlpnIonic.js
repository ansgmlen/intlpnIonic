...
.directive('intlpn',  ['$ionicModal', '$timeout', '$ionicScrollDelegate', function( $ionicModal, $timeout, $ionicScrollDelegate ) {
    return {
        ...
        link:function (scope, element, attrs, ngModelCtrl) {
            ...
            scope.modalScope = {
                selectCountry: function( country ) {
                    ...
                    scope.phone = ""; //when user change country, clear prev one
        ...
        template: '<div class="item item-input intlpn-container">' +
                        ...
                        '<input intlpn-formatter national-mode="nationalMode" iso-code="{{isocode}}" type="tel" placeholder="{{placeholder}}" ng-model="phone" maxlength="{{maxlength}}">' +
                '</div>'
    };
}])
